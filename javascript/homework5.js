 ...
 */
const getAllNames = users => {return users.map(users => users.name)};
//
 ...
 */
const getUsersByEyeColor = (arr, color) => { return arr.filter(users => users.eyeColor === color)};
//
...
//  */
const getUsersByGender = (arr, gender) => { return arr
...
//  */
const getInactiveUsers = arr => {return arr.filter(arr => !arr.isActive)};
// //
...
// //  */
const getUserByEmail = (arr, email) => {return arr.find(arr => arr.email === email)};
// //
...
// //  */
const getUsersWithAge = (arr, min, max) => {return arr.filter(arr => (min < arr.age) & (arr.age < max))};
// //
...
//  */
const getTotalBalance = arr => {return arr.reduce((a, b) => a + b.balance, 0)};
//
...
//  */
const getUsersByFriend = (arr, name) => {return arr
  .filter(arr => arr.friends[0] === name || arr.friends[1] === name)
  .map(arr => arr.name)
};
//
